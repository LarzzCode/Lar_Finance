              ...
              <div className="px-4 pt-2 pb-6 space-y-2">
                ...
                <div className="pt-4 mt-2 border-t border-gray-100">
                  <button
                    ...
                    className="w-full text-left block px-4 py-3 rounded-xl text-base font-bold text-red-600 hover:bg-red-50 hover:pl-6 transition-all flex items-center gap-2"
                  >
                    Logout
