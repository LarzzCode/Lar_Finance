...
export default function Categories() {
  ...
  const handleDelete = async (id) => {
    ...
    if (error) {
      // Error biasanya karena kategori ini sedang dipakai di transaksi
      if (error.code === '23503') { // Kode error Foreign Key Violation
        toast.error('Gagal! Kategori ini sedang dipakai di riwayat transaksi.');
      } else {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="mb-8 text-center">
        ...
        <p className="text-sm text-gray-500">Tambah atau hapus kategori sesuai kebutuhanmu.</p>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 mb-10 max-w-lg mx-auto">
        <form onSubmit={handleAdd} className="flex flex-col gap-4">
          <div>
            ...
            <input 
              type="text" 
              placeholder="Contoh: Pulsa, Parkir, Investasi..." 
          ...
          <div className="flex gap-4">
            ...
            <div className="flex items-end">
              <button 
                type="submit" 
                className="px-6 py-3 bg-orange-600 text-white font-bold rounded-xl hover:bg-orange-700 transition-colors shadow-md h-[50px]"
              >
                Tambah
              </button>
            </div>
