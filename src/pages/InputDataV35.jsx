...
export default function InputDataV35() {
  const { user } = useAuth();
    ...
    <main className="min-h-screen pb-32 md:pb-16 pt-8 md:pt-32 text-slate-900 dark:text-slate-100">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <header className="mb-7 md:mb-9 max-w-3xl">
          ...
          <p className="text-[10px] font-medium uppercase tracking-[0.16em] text-slate-400 mb-2">Lar Finance V3.5</p>
          <h1 className="text-[2rem] md:text-[2.7rem] font-semibold tracking-[-0.04em]">Catat arus kas</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-2">
            Auto-category, split transaction, dan saldo hasil rekonsiliasi sekarang bekerja dalam satu flow.
          </p>
        </header>
